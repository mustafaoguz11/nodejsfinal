        ...
        (f.prototype = {
            ...
            createDropdown: function () {
                var b = this.multiple ? " show-tick" : "",
                    ...
                    h = this.options.actionsBox
                        ...
                        : "",
                    i =
                        '<div class="btn-group bootstrap-select col-12"' +
                        b +
                        c +
                        ...
                        d +
                        '><span class="filter-option pull-left"></span>&nbsp;</button><div class="dropdown-menu open">' +
                        f +
                        g +
                        h +
                        ...
                        b.$searchbox.val()
                            ? (b.options.searchAccentInsensitive
                              ...
                              b.$menu.find("li").filter(":visible:not(.no-results)").length
                                  ...
                                  : (e.parent().length && e.remove(), e.html(b.options.noneResultsText + ' "' + d(b.$searchbox.val()) + '"').show(), b.$menu.find("li").last().after(e)))
            ...
            keydown: function (b) {
                ...
                if (
                    ...
                    !l && /([0-9]|[A-z])/.test(String.fromCharCode(b.keyCode)) && (o.options.container ? o.$newElement.trigger("click") : (o.setSize(), o.$menu.parent().addClass("open"), (l = !0)), o.$searchbox.focus()),
                    o.options.liveSearch &&
                        ...
                        m.val() ||
                            ...
                            (0 === d.filter(".active").length && (d = o.$newElement.find("li").filter(o.options.searchAccentInsensitive ? ":aicontains(" + c(p[b.keyCode]) + ")" : ":icontains(" + p[b.keyCode] + ")")))),
                    d.length)
                ) {
                    if (/(38|40)/.test(b.keyCode.toString(10)))
                        (e = d.index(d.filter(":focus"))),
                            ...
                            m.data("prevIndex", e),
                            o.options.liveSearch ? (b.preventDefault(), m.is(".dropdown-toggle") || (d.removeClass("active"), d.eq(e).addClass("active").find("a").focus(), m.focus())) : d.eq(e).focus();
                    else if (!m.is("input")) {
                        var q,
                            r,
                            s = [];
                    ...
                    (/(13|32)/.test(b.keyCode.toString(10)) || (/(^9$)/.test(b.keyCode.toString(10)) && o.options.selectOnTab)) &&
                        ...
                        ((/(^9$|27)/.test(b.keyCode.toString(10)) && l && (o.multiple || o.options.liveSearch)) || (/(27)/.test(b.keyCode.toString(10)) && !l)) && (o.$menu.parent().removeClass("open"), o.$button.focus());
                }
            },
            mobile: function () {
